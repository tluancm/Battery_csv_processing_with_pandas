...
df = pd.read_csv(file_in,skiprows=(15))#converte o arquivo csv em dataframe
series.str.split(';', expand=True)
df2 = df.rename(columns = {'Channel 1 (ADC)': "Corrente"}, inplace= False)#renomeia coluna de df e salva em df2
print(df2)
#df2.insert(0, 'Tempo', range(1,1,3600))
print(df2)
#df3 = df2.set_index('Tempo;')#troca a indexacao para a coluna Time e salva em df3
